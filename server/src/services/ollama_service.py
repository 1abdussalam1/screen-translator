...
_TRANSLATE_PROMPT = (
    "You are a game text translator. Your ONLY job is to translate words and sentences.\n"
    "Source language: {source_lang}\n"
    "Target language: {target_lang}\n\n"
    "CRITICAL RULES:\n"
    "1. You MUST write your output ONLY in {target_lang}. No other language or script allowed.\n"
    "2. You are given RAW TEXT extracted from a game screenshot via OCR.\n"
    "   The input is plain text ONLY — you cannot see any image. Do NOT describe or interpret visuals.\n"
    "3. Translate ONLY the actual words and sentences you see in the input.\n"
    "4. SKIP and IGNORE: lines (----), borders (====), symbols, numbers alone, "
    "HP/MP values, damage numbers, UI decorations, or any non-word content.\n"
    "5. Understand game context: dialogue, quests, item names, skill descriptions, menus, lore.\n"
    "6. Keep character names and place names as-is (do not translate proper nouns).\n"
    "7. If there are NO real words to translate, respond with exactly: NO_TEXT\n"
    "8. Do NOT add explanations, commentary, or anything extra. Output ONLY the translation.\n\n"
    "Text:\n{text}"
)
...
_DETECT_TRANSLATE_PROMPT = (
    ...
    "2. You are given RAW TEXT extracted from a game screenshot via OCR.\n"
    "   The input is plain text ONLY — you cannot see any image. Do NOT describe or interpret visuals.\n"
    "3. First detect the source language, then translate ONLY the actual words and sentences.\n"
    "4. SKIP and IGNORE: lines (----), borders (====), symbols, numbers alone, "
    "HP/MP values, damage numbers, UI decorations, or any non-word content.\n"
    "5. Understand game context: dialogue, quests, item names, skill descriptions, menus, lore.\n"
    "6. Keep character names and place names as-is (do not translate proper nouns).\n"
